...
SOURCEFILES_QUOTED_IF_SPACED=../src/system_config/exp16/dspic33ep256gp506/main_fft_example.c ../src/inputsignal_square1khz.c ../src/twiddle_factors.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1509574111/main_fft_example.o ${OBJECTDIR}/_ext/1360937237/inputsignal_square1khz.o ${OBJECTDIR}/_ext/1360937237/twiddle_factors.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1509574111/main_fft_example.o.d ${OBJECTDIR}/_ext/1360937237/inputsignal_square1khz.o.d ${OBJECTDIR}/_ext/1360937237/twiddle_factors.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1509574111/main_fft_example.o ${OBJECTDIR}/_ext/1360937237/inputsignal_square1khz.o ${OBJECTDIR}/_ext/1360937237/twiddle_factors.o

# Source Files
SOURCEFILES=../src/system_config/exp16/dspic33ep256gp506/main_fft_example.c ../src/inputsignal_square1khz.c ../src/twiddle_factors.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-dspic33ep256gp506.mk dist/${CND_CONF}/${IMAGE_TYPE}/fft_dsplib.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1509574111/main_fft_example.o: ../src/system_config/exp16/dspic33ep256gp506/main_fft_example.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1509574111/main_fft_example.o.d 
	@${RM} ${OBJECTDIR}/_ext/1509574111/main_fft_example.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/system_config/exp16/dspic33ep256gp506/main_fft_example.c  -o ${OBJECTDIR}/_ext/1509574111/main_fft_example.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1509574111/main_fft_example.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_dspic33ep256gp506=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O1 -I"../src" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/1509574111/main_fft_example.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/1360937237/twiddle_factors.o: ../src/twiddle_factors.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360937237/twiddle_factors.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/twiddle_factors.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/twiddle_factors.c  -o ${OBJECTDIR}/_ext/1360937237/twiddle_factors.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1360937237/twiddle_factors.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_dspic33ep256gp506=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O1 -I"../src" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/twiddle_factors.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/fft_dsplib.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/fft_dsplib.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1  -omf=elf -DXPRJ_dspic33ep256gp506=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x1000:0x101B -mreserve=data@0x101C:0x101D -mreserve=data@0x101E:0x101F -mreserve=data@0x1020:0x1021 -mreserve=data@0x1022:0x1023 -mreserve=data@0x1024:0x1027 -mreserve=data@0x1028:0x104F   -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_REAL_ICE=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library=dsp,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/fft_dsplib.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/fft_dsplib.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -DXPRJ_dspic33ep256gp506=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library=dsp,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
